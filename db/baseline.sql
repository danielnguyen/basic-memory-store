-- Basic Memory Store frozen schema baseline.
-- This file is an immutable cutover snapshot used only for fresh installs and
-- explicit baseline adoption. Do not edit this file for future schema changes.
-- All future schema changes must be added as managed migrations.
